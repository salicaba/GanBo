...
function App() {
  ...
  // === MOTOR DE RECÁLCULO DEL LIBRO MAYOR ===
  const obtenerCuentasMayorCalculadas = () => {
    // 1. Iniciamos con las cuentas originales de Python
    const cuentasMap = {};
    ...
    // 2. Le inyectamos los nuevos asientos que hayas creado
    asientosDiario.forEach((asiento, index) => {
      const refActual = `N-${index + 1})`; // Le ponemos la N para identificar que es Nuevo
    ...
    // 3. Calculamos los saldos finales actualizados
  ...
  return (
    <div className="dashboard">
      ...
      <div className="layout-container">
        {/* PANEL RÁPIDO PARA BALANCES BÁSICOS */}
        ...
        {/* PANEL PARA LIBRO DIARIO Y MAYOR */}
